...
!function(i, h, m, f, d, k, e) {
    ...
    var b = i.$Jssor$ = new function() {
        var j = this, xb = /\S+/g, K = 1, eb = 2, hb = 3, gb = 4, kb = 5, L, r = 0, n = 0, C = 0, x = navigator, qb = x.appName, p = x.userAgent, q = parseFloat;
        function Gb() {
            if (!L) {
                L = {
                ...
                var a;
                if (x.pointerEnabled || (a = x.msPointerEnabled))
                    L.ze = a ? "msTouchAction" : "touchAction"
            }
            return L
        }
        function u(g) {
            ...
            if (a) {
                ...
                if (H()) {
                    if (a.$TranslateX || a.$TranslateY || a.$TranslateZ != e)
                        b += " translate3d(" + (a.$TranslateX || 0) + "px," + (a.$TranslateY || 0) + "px," + (a.$TranslateZ || 0) + "px)";
                    if (a.$ScaleX == e)
                        a.$ScaleX = 1;
                    if (a.$ScaleY == e)
                        a.$ScaleY = 1;
        ...
        j.Pg = function(d, a) {
            if (a)
                d.style.clip = "rect(" + c.$Round(a.$Top || a.N || 0) + "px " + c.$Round(a.$Right) + "px " + c.$Round(a.$Bottom) + "px " + c.$Round(a.$Left || a.K || 0) + "px)";
            else if (a !== e) {
        ...
        j.Og = function(b, a) {
            if (a)
                b.style.backgroundColor = "rgba(" + c.$Round(a.Fd) + "," + c.$Round(a.Ad) + "," + c.$Round(a.Od) + "," + a.$Opacity + ")"
        }
        ;
        j.Db = function() {
            return +new Date
        ...
        j.Ae = function(o, j, s, t, D, E, p) {
            ...
            if (o) {
                ...
                for (var i in j) {
                    ...
                    if (h != y)
                        h -= y;
                    var k = t.X || g.$Linear, m, G = o[i], r = j[i];
                    if (b.uc(r)) {
                        k = t[i] || k;
                        var C = k(h);
                        m = G + r * C
            ...
            if (a.$Clip && !a.$Clip.$Top && !a.$Clip.$Left && !a.$Clip.N && !a.$Clip.K && a.$Clip.$Right == p.$OriginalWidth && a.$Clip.$Bottom == p.$OriginalHeight)
                a.$Clip = f;
            return a
        }
    }
    ...
    var l = function(C, F, h, m, T, O) {
        C = C || 0;
        var a = this, p, n, o, t, D = 0, Q = 1, M, N, L, E, B = 0, j = 0, r = 0, A, l, f, g, s, z, v = [], y, I = k, J, H = k;
        function U(a) {
            f += a;
            g += a;
            l += a;
    ...
    var n = {
      ...
      , s = i.$JssorSlideshowFormations$ = new function() {
        ...
        h.$FormationSwirl = function(q) {
            var x = q.$Cols, y = q.$Rows, B = q.$Assembly, w = q.sc, A = [], z = [], u = 0, c = 0, h = 0, r = x - 1, s = y - 1, t, p, v = 0;
            switch (B) {
            case j:
                c = r;
                h = 0;
        ...
        h.$FormationZigZag = function(p) {
            var w = p.$Cols, x = p.$Rows, z = p.$Assembly, v = p.sc, t = [], u = 0, c = 0, d = 0, q = w - 1, r = x - 1, y, h, s = 0;
            switch (z) {
            case j:
                c = q;
                d = 0;
    ...
    i.$JssorSlideshowRunner$ = function(m, r, p, u, z, A) {
        ...
        function n(z, i, a, v, n, l) {
            var y = this, t, u = {}, h = {}, m = [], f, e, r, p = a.$ChessMode.$Column || 0, q = a.$ChessMode.$Row || 0, g = a.Se(n, l), o = B(a), C = o.length - 1, s = a.$Duration + a.$Delay * C, w = v + s, j = a.$SlideOut, x;
            w += 50;
            function B(a) {
                var b = a.$Formation(a);
    ...
    var t = i.$JssorCaptionSlideo$ = function() {
        ...
        function db(o, p, g) {
            ...
            if (a && e) {
                e.Je();
                var h = e, j, i = e.Dc(), m = e.nb(), n = c.m(m, a.Mg);
                if (a.ub < m) {
                    if (a.ub > i) {
                        h = new l(i,a.ub - i);
                        h.W(e, d)
      ...
      , j = i.$JssorSlider$ = (i.module || {}).exports = function() {
        ...
        function cd(w, h) {
            var g = this, jb = b.Y(g, o), y, G = 0, V, u, E, A, J, n, F = [], U, M, Q, i, r, z, S;
            l.call(g, -N, N + 1, {
                lc: C & 1 ? q : e,
                $Reverse: Hb
            });
        ...
        function bd(F, h, q, r) {
            var c = this, E = b.Y(c, o), i = 0, u = 0, g, m, f, e, n, w, v, y = x[h];
            l.call(c, 0, 0);
            function B() {
                c.Jc()
            }
        ...
        a.B = function(i, f) {
            ...
            m.$HWA = m.$HWA && b.Wg();
            if (m.$Idle != e)
                m.$AutoPlayInterval = m.$Idle;
            if (m.$DisplayPieces != e)
                m.$Cols = m.$DisplayPieces;
            if (m.$ParkingPosition != e)
            ...
            b.c(c, function(a, d) {
                ...
                if (c == "loading")
                    ...
                    if (a.tagName != "STYLE" && a.tagName != "SCRIPT")
                        nc[c || d] = new Rc(a,c == "slides",b.Dd(["slides", "thumbnavigator"])[c])
                }
            });
            R && b.qb(R);
            R = R || b.Rb(h);
